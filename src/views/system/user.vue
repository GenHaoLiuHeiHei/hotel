        ...
        option: {
          ...
          column: [
            ...
            },
            {
              ...
              prop: "tenantId",
              type: "tree",
              dicUrl: "/api/hotel-system/tenant/select",
              props: {
                label: "tenantName",
                value: "tenantId"
              },
          ...
          column: [
            {
              ...
              action: "/api/hotel-system/import-user"
            },
            {
              label: '模板下载',
              prop: 'excelTemplate',
    ...
    methods: {
      ...
      handleExport() {
        this.$confirm("是否导出用户数据?", "提示", {
          ...
          window.open(`/api/hotel-system/export-user?blade-auth=${getToken()}&account=${searchForm.account}&realName=${searchForm.realName}`);
        });
      },
      handleTemplate() {
        window.open(`/api/hotel-system/export-template?blade-auth=${getToken()}`);
      },
